...
if (!message) {
	console.log("Usage: pick.js [--url=<substring>] [--label=<name>] 'message'");
	console.log("\nExamples:");
	console.log('  pick.js "Click the submit button"');
	console.log('  pick.js --url=foo.com "Click the submit button"  # pick on a specific tab');
	console.log('  pick.js --label=hn "Click the submit button"     # pick on the labeled tab');
	process.exit(1);
}
