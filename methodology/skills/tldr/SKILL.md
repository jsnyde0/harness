...
- **Label-soup children.** `.11 ADR-014 D1+D2+D3 + auto-Profile reachable / .12 ADR-008 D1+D3 cleanups` is opaque markers. Translate: "two follow-up beads from re-verifying the parent — `.11` fixed three ADR-014 violations and made auto-created Profile records reachable from the signup flow; `.12` cleaned up two ADR-008 conformance gaps." Cite the D-labels as warrant, not as the description.
