...
2. **Author the bead** with `--design` carrying decisions (FIRM/FLEXIBLE/EXPLORATORY + rationale + alternatives + "what would invalidate") and a `## canonical_refs` section.
...
- **Skipping design review because "the impl is small."** Frame-distance matters most when you authored the design moments ago. Default-on.
